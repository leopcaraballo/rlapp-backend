...
public sealed class MarkAbsentAtConsultationCommandHandler
{
    private readonly IEventStore _eventStore;
    private readonly IEventPublisher _eventPublisher;
    private readonly IClock _clock;

    public MarkAbsentAtConsultationCommandHandler(
    ...
    public async Task<int> HandleAsync(
        MarkAbsentAtConsultationCommand command,
        CancellationToken cancellationToken = default)
    {
        ...
        var request = new MarkAbsentAtConsultationRequest
        {
        ...
        queue.MarkAbsentAtConsultation(request);
